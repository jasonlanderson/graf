...
class DashboardController < ApplicationController
  ...
  def index
	...
	@prs_by_user_table_str = JavascriptUtils.create_pull_request_table(prs_by_user, 'login', 'calculated_value')
    ...
    @prs_by_company_table_str = JavascriptUtils.create_pull_request_table(prs_by_company, 'name', 'calculated_value')
  end
