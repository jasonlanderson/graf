  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved org as @org" do
        ...
        post :create, {:org => { "git_id" => "invalid value" }}, valid_session
        assigns(:org).should be_a_new(Org)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested org" do
        ...
        Org.any_instance.should_receive(:update).with({ "git_id" => "1" })
        put :update, {:id => org.to_param, :org => { "git_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the org as @org" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Org.any_instance.stub(:save).and_return(false)
        put :update, {:id => org.to_param, :org => { "git_id" => "invalid value" }}, valid_session
        assigns(:org).should eq(org)
      end
